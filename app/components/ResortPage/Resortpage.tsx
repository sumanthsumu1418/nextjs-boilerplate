...
const LuxuryLivingSection = () => {
  return (
    <section className="bg-[#F5F0E5] py-12 px-4 md:px-16 lg:px-32">
  ...
  return (
    <section className="bg-[#F5F0E5] py-12 px-4 md:px-16 lg:px-32">
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="relative">
          <Image
            src="/path-to-your-offer-image.jpg"
            alt="Grand Opening"
            width={800} 
            height={600}
            className="w-full h-auto object-cover"
    ...
    <section className="bg-[#F5F0E5] py-12 px-4 md:px-16 lg:px-32">
      <div className="grid md:grid-cols-2 gap-12">
        ...
        <div className="flex flex-col items-center">
          <Image
            src="/path-to-your-left-image.jpg"  // Replace with your large image path
            alt="Luxury Living"
            width={500}
            height={600}
            className="w-full h-auto object-cover"
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div className="relative">
              <Image
                src="/path-to-your-second-image.jpg"  // Replace with your right image
                alt="Accommodation 1"
                width={400}
                height={300}
                className="w-full h-auto object-cover"
            ...
            <div className="relative">
              <Image
                src="/path-to-your-third-image.jpg"  // Replace with another image
                alt="Accommodation 2"
                width={400}
                height={300}
                className="w-full h-auto object-cover"
